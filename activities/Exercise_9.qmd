...
*students_1 has the student letter*

-   Relative to this key, what info does `enrollments_1` have that `students_1` doesn't?

*enrollments_1 has the number of students in each class*
...
*The letter of the students and class was kept from students_1 and a column with enrollment was added*

-   What, if anything, would change if we reversed the order of the data tables? Think about it, then try.

*You would have ART instead of ANTH and a column with the students letter will be added.*

```{r}
library(tidyverse)
enrollments_1 |> 
  right_join(students_1)
```
...
*It joined the rows that had data on all sections between students_1 and enrollments_1*

-   What, if anything, would change if we reversed the order of the data tables? Think about it, then try.

*The columns would move around I think*
...
*All the date from both tables was added*

-   What, if anything, would change if we reversed the order of the data tables? Think about it, then try.

*The column order would change* 
