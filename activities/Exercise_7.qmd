---
title: "Exercise 7 - Effective Viz"
...
ggplot(weather, aes(y = temp3pm, x = temp9am, color = location)) + 
  geom_point() + 
  labs(x = "Temp @ 9am", y = "Temp @ 3pm", title = "Temperature at 3pm and 9pm in Australian Towns", color = "Location")  
```
...
```{r}
#| fig-cap: "Comparison of temperatures at 9am and 3pm in three different Australian locations "
...
#| fig-alt: "This density plot shows that between three different locations in Australia, Uluru has the highest temperatures, Wollongong the second highest and Hobart has the lowest temperatures at 3pm. "
...
Getting into even more of the nitty gritty, we need to be mindful of what geometric elements and aesthetics we use. The following elements/aesthetics are listed in roughly descending order of human ability to perceive and compare nearby objects:[^exercise_7-2]

[^exercise_7-2]: B. S. Baumer, D. T. Kaplan, and N. J. Horton, *Modern Data Science with R*, 2017, p. 15.
