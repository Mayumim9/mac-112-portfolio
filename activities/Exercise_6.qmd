...
Summarize what you learned about Starbucks from this map. **Starbucks are extremely popular in the United States and East Asia.**
...
```{r}
# The points are now contours
# we also changed geom_point to geom_density_2d
ggplot(cma_boundaries) + 
  geom_sf() + 
  geom_density_2d(
    data = starbucks_cma,
